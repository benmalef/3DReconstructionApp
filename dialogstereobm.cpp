...
void DialogStereoBM::stereoBMexecute() {
  ...
  cpuStereoBM->setPreFilterCap(55);
...
void DialogStereoBM::readImageStereoBMexecute() {
  ...
  auto cpuStereoBM = StereoBM::create(numDisparities, blockSize);
  int down_width = 900;
  int down_height = 1080;

  leftFrame =
      imread("/home/benmalef/Desktop/StereoApp/StereoImages/imageL0.png");
  rightFrame =
      imread("/home/benmalef/Desktop/StereoApp/StereoImages/imageR0.png");

  cv::resize(leftFrame, leftFrame, Size(down_width, down_height), INTER_LINEAR);
  cv::resize(rightFrame, rightFrame, Size(down_width, down_height),
             INTER_LINEAR);
